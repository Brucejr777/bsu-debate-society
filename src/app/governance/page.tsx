        ...
        <div className="space-y-10">
          ...
          <article className="rounded-3xl border border-neutral-800 bg-neutral-950/95 p-8 shadow-xl shadow-black/30">
            <div className="mx-auto max-w-3xl space-y-6 text-center">
              ...
              {/* FIX 13: Adversarial Mandate & Appeal Details */}
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 mt-6 text-left">
                <div className="rounded-2xl border border-neutral-700 bg-neutral-900/60 p-5">
                  <h3 className="text-lg font-semibold text-white mb-2 text-center">Adversarial Mandate</h3>
                  <p className="text-sm leading-6 text-neutral-400">
                    In the pursuit of institutional justice, the Tribunal adopts a specialized adversarial mandate. The Chancellor of the House to which the respondent belongs is constitutionally bound to act as the <strong className="text-neutral-200">Counsel for the Defense</strong>. Conversely, the remaining three Chancellors constitute the <strong className="text-neutral-200">Commission on Prosecution</strong>, representing the standing of the Society and the sanctity of its laws.
                  </p>
                  <p className="mt-2 text-xs italic text-neutral-500 text-center">— Article 10, Section 3</p>
                </div>
                <div className="rounded-2xl border border-neutral-700 bg-neutral-900/60 p-5">
                  <h3 className="text-lg font-semibold text-white mb-2 text-center">Right to Appeal & Re-Trial</h3>
                  <p className="text-sm leading-6 text-neutral-400">
                    Any party aggrieved by the verdict of the High Tribunal reserves the right to a singular appeal. A <strong className="text-neutral-200">Re-Trial</strong> shall be convened, presided over by the Society&apos;s <strong className="text-neutral-200">Chief Adviser</strong>. The Adviser reviews the evidence and the law, and their appellate decision is final, executory, and beyond further challenge.
                  </p>
                  <p className="mt-2 text-xs italic text-neutral-500 text-center">— Article 10, Section 5</p>
                </div>
              </div>
            </div>
          </article>
