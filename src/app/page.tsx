export default function Home() {
  return (
    <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-16 sm:px-10 lg:px-16">
      <section className="rounded-3xl border border-[#daa520]/30 bg-gradient-to-br from-neutral-950/90 via-neutral-900/70 to-neutral-950/80 p-10 shadow-2xl shadow-black/40 backdrop-blur-xl">
          <div className="space-y-10">
            <div className="space-y-4 text-center">
              <p className="text-sm uppercase tracking-[0.35em] text-neutral-500">
                Benguet State University
              </p>
              <h1 className="inline-block rounded-full bg-gradient-to-r from-[#f9e076] via-[#d4af37] to-[#9b5f0f] px-5 py-2 text-3xl font-semibold tracking-tight text-neutral-950 sm:text-4xl">
                Debate Society
              </h1>
            ...
            <div className="grid gap-8 lg:grid-cols-[1.4fr_0.8fr]">
              <div className="space-y-8">
                <article className="group rounded-3xl border border-[#daa520]/30 bg-neutral-950/90 p-8 shadow-lg shadow-black/20 transition-all duration-200 hover:border-[#daa520]/50 hover:shadow-xl hover:shadow-[#ffd700]/15">
                ...
                <div className="rounded-3xl border border-[#daa520]/30 bg-neutral-950/90 p-8 shadow-lg shadow-black/20">
                  <h2 className="text-2xl font-semibold text-white">Our Core Principles</h2>
                  <div className="mt-6 grid gap-4 sm:grid-cols-2">
                    <div className="group rounded-2xl border border-[#daa520]/20 bg-neutral-900/80 p-5 transition-all duration-200 hover:border-[#daa520]/40 hover:bg-neutral-900">
              ...
              <aside className="space-y-6">
                <div className="rounded-3xl border border-[#daa520]/40 bg-gradient-to-b from-neutral-950 to-neutral-900/90 p-8 shadow-lg shadow-black/20 gold-glow">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <a
                        href="/houses"
                        className="group inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#f9e076] via-[#d4af37] to-[#9b5f0f] px-6 py-3 text-sm font-semibold text-neutral-950 transition-all duration-200 hover:from-[#ffb800] hover:to-[#ff4d00] hover:shadow-lg hover:shadow-[#ffd700]/25"
                      >
                        Explore Our Houses
                ...
                <div className="rounded-3xl border border-[#daa520]/30 bg-neutral-950/80 p-5 shadow-sm shadow-black/20">
