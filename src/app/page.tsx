...
export default function Home() {
  return (
    <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-16 sm:px-10 lg:px-16">
      <section className="rounded-3xl border border-[#D4AF37]/40 bg-gradient-to-br from-neutral-950 via-neutral-900/50 to-neutral-950 p-10 shadow-2xl shadow-black/50 backdrop-blur-xl">
        <div className="space-y-12">
          ...
          <div className="space-y-4 text-center">
            ...
            <h1 className="inline-block rounded-full bg-gradient-to-r from-[#D4AF37] via-[#F5D76E] to-[#D4AF37] px-6 py-2 text-3xl font-semibold tracking-tight text-neutral-950 sm:text-4xl">
              Debate Society
            </h1>
            <p className="mx-auto max-w-3xl text-lg leading-8 text-neutral-300 sm:text-xl">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.4fr_0.8fr]">
            ...
            <div className="space-y-10">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <article className="group rounded-3xl border border-[#D4AF37]/30 bg-neutral-950/80 p-8 shadow-lg shadow-black/20 transition-all duration-200 hover:border-[#D4AF37]/60 hover:shadow-xl hover:shadow-[#D4AF37]/10">
              ...
              {/* Core Principles */}
              <div className="rounded-3xl border border-[#D4AF37]/30 bg-neutral-950/80 p-8 shadow-lg shadow-black/20">
              ...
              {/* The Four Houses Preview */}
              <div className="rounded-3xl border border-[#D4AF37]/30 bg-neutral-950/80 p-8 shadow-lg shadow-black/20">
                <h2 className="text-2xl font-semibold text-white">The Four Houses</h2>
                <p className="mt-2 text-sm text-neutral-400">
                  Four permanent and chartered Houses, each representing a unique philosophical and symbolic identity.
                </p>
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  {HOUSES.map((house) => (
                    <a
                      ...
                      className="group relative overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900/80 p-5 transition-all duration-200 hover:scale-[1.02] hover:border-[#D4AF37]/40"
                    >
                      <div
                      ...
                      <div className="pl-3">
                        ...
                        <span
                          className="mt-1 inline-block rounded-full px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-white"
                          style={{ backgroundColor: house.color }}
                        >
                          {house.value}
                        </span>
                        <p className="mt-3 text-xs leading-5 text-neutral-400 line-clamp-3">
                          {house.description}
                        </p>
                      </div>
                    </a>
            ...
            <aside className="space-y-6">
              <div className="rounded-3xl border border-[#D4AF37]/40 bg-gradient-to-b from-neutral-950 to-neutral-900/90 p-8 shadow-lg shadow-black/20">
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <a
                      href="/houses"
                      className="group inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#D4AF37] via-[#F5D76E] to-[#D4AF37] px-6 py-3 text-sm font-semibold text-neutral-950 transition-all duration-200 hover:from-[#F5D76E] hover:to-[#D4AF37] hover:shadow-lg hover:shadow-[#D4AF37]/25"
                    >
                      Explore Our Houses
