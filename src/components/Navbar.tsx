    ...
    <>
      ...
      >
        ...
        <a href="/" className="group flex items-center gap-3 px-6 py-6">
          <span className="rounded-full bg-gradient-to-br from-[#ffde00] via-[#ffb800] to-[#ff4d00] px-2.5 py-1 text-xs font-bold tracking-widest text-neutral-950 transition-transform group-hover:scale-105 shadow-[0_0_12px_rgba(255,215,0,0.3)]">
            BSU
          </span>
      ...
      <header className="sticky top-0 z-50 border-b border-neutral-800/80 bg-gradient-to-r from-neutral-950/95 via-neutral-900/95 to-neutral-950/95 backdrop-blur-xl lg:hidden">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 sm:px-10">
          ...
          <a href="/" className="flex items-center gap-3 text-sm font-semibold">
            <span className="rounded-full bg-gradient-to-br from-[#ffde00] via-[#ffb800] to-[#ff4d00] px-2.5 py-1 text-xs font-bold tracking-widest text-neutral-950 transition-transform hover:scale-105 shadow-[0_0_12px_rgba(255,215,0,0.3)]">
              BSU
            </span>
